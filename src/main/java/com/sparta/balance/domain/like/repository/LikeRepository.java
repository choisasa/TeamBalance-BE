...
public interface LikeRepository extends JpaRepository<Like, Long> {
    Optional<Like> findByGameAndChoiceAndUser(Game game, Choice choice, User user);

    Optional<Like> findByGameAndCommentAndUser(Game game, Comment comment, User user);
}
